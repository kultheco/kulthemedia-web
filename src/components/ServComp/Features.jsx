  ...
  return (
    <section className="pt-12 pb-12">
      <div className="text-white">
        <div className="flex justify-center items-center uppercase space-x-12">
          <div className="">
            <h1 className="text-9xl headings font-bold text-left max-w-2xl">
        ...
        <div className="flex justify-center items-center py-16">
          <div className="grid grid-cols-2 justify-center items-center gap-4 max-w-7xl">
            {whatYouGet.map((feature, index) => (
              <div className="border-2 rounded-3xl">
                <div className="p-6">
                  <h1 className="text-4xl capitalize font-semibold" key={index}>
                    {feature.heading}
                  </h1>
