      ...
      >
        <div className="flex justify-center py-12">
          <div className="flex justify-center items-center space-x-5 max-w-6xl px-4 md:px-6 lg:px-3">
            <h1
              className="text-left text-3xl md:text-6xl lg:text-7xl font-bold uppercase"
              style={h1styles}
            >
            ...
            <a
              href="/"
              className="focus:ring-4 focus:outline-none border-2 font-medium rounded-full text-3xl md:text-7xl px-3 md:px-6 py-3 text-center mr-3 md:mr-0"
              style={anchorStyles}
            >
              &rarr;
            </a>
